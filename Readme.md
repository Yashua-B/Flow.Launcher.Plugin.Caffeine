...
2. To install directly from the repo paste the following into Flow launcher `pm install https://github.com/o850cHQk/Flow.Launcher.Plugin.Caffeine/releases/download/v1.1.0/Caffeine-1.1.0.zip`
